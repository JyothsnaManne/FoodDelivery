...
import { fetchRestaurantbyid, fetchMenuById } from '../actions/foodActions';



class ViewRestaurentsMenu extends Component {



    componentDidMount() {
        this.props.fetchRestaurantbyid(this.props.match.params.restaurantId)
        this.props.fetchMenuById(this.props.match.params.restaurantId)
    }
...
const mapStateToProps = state => ({
    ...
    menuItems: state.reducer.menuList
});



export default connect(mapStateToProps, { fetchRestaurantbyid, fetchMenuById })(ViewRestaurentsMenu);